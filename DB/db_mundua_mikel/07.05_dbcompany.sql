...
join departments D 
				on  E.dept_id = D.id
									order by dept_id;
# 2. Langile bakoitzak zein departamentuetan lan egiten duen jakin nahi dugu. Baina kasu honetan, langile batek ez baldin badu departamenturik esleituta, 
#edo existitzen ez den baldin badu esleituta, bere izena ere agertzea nahi dugu. Langile izena eta departamentuaren izena erakutsi
